  ...
  <div>
      ...
      <div class="flow-container" ref="flowContainer">
        <super-flow
          ...
          <template v-slot:node="{meta}">
            <div @mouseup="nodeMouseUp" @click="nodeClick" class="flow-node ellipsis"> {{ meta.name }}</div>
          </template>
        </super-flow>
      </div>
    </div>
    ...
    <el-dialog
      ...
      <el-form
        ...
        <el-form-itemlabel="节点描述" prop="desc">
...
export default {
	components:{"super-flow":SuperFlow},
  data () {
    return {

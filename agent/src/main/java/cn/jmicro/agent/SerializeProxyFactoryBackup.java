	...
	private static  String getDecodeMethod(CtClass cls) throws NotFoundException, CannotCompileException {
		...
		for(int i = 0; i < fields.length; i++) {
			...
			if(fieldDeclareType == CtClass.intType || fieldDeclareType.getName().equals(Integer.class.getName()) ) {
				...
				sb.append(" if(0 != (cn.jmicro.common.Constants.NULL_VAL & " + flagName +")) { ");
				sb.append(varName).append("  = null;\n } else { // block0 \n");
				...
				if(!fieldDeclareType.subtypeOf(cp.get(Collection.class.getName())) &&
					...
					if(fieldDeclareType.subtypeOf(cp.get(Collection.class.getName()))) {
				    	...
				    	if(fieldDeclareType.isInterface() || Modifier.isAbstract(fieldDeclareType.getModifiers())) {
				    		sb.append(" if(0 != (cn.jmicro.common.Constants.TYPE_VAL & "+flagName+")) { \n");
				    		...
				    		sb.append("  cls = cn.jmicro.agent.SerializeProxyFactory.loadClazz(clsName); \n");
				    		sb.append(" } else {  \n");
				    		sb.append(" cls = cn.jmicro.api.codec.TypeCoderFactory.getClassByCode(new Short(c)); \n");
				    		sb.append(" } \n");
				    	...
				    	sb.append(" if(0 == (cn.jmicro.common.Constants.GENERICTYPEFINAL & "+flagName+")) { //blockgenic \n");
				    	
				    	sb.append(" if(0 != (cn.jmicro.common.Constants.HEADER_ELETMENT & "+flagName+")) { \n");
				    	sb.append(" readEvery = false;\n ");
				    	sb.append(" if(0 != (cn.jmicro.common.Constants.ELEMENT_TYPE_CODE & "+flagName+")) { \n");
				    	sb.append(" c = __buffer.readShort(); \n");
				    	sb.append(" eleCls = cn.jmicro.api.codec.TypeCoderFactory.getClassByCode(new Short(c)); \n");
				    	sb.append(" } \n else { \n");
				    	sb.append(" clsName = __buffer.readUTF(); \n");
				    	sb.append(" eleCls = cn.jmicro.agent.SerializeProxyFactory.loadClazz(clsName); \n");
				    	sb.append(" } \n");
			    		...
			    		sb.append(" if(prefixCode == cn.jmicro.api.codec.Decoder.PREFIX_TYPE_NULL ){ "+varName+".add(null);; continue;}");
			    		sb.append(" if(prefixCode == cn.jmicro.api.codec.Decoder.PREFIX_TYPE_SHORT) { \n");
			    		sb.append("  c =  __buffer.readShort(); \n");
			    		sb.append("  eleCls = cn.jmicro.api.codec.TypeCoderFactory.getClassByCode(new Short(c)); \n ");
			    		sb.append(" } else { \n");
			    		sb.append(" java.lang.String cn = __buffer.readUTF(); \n");
				    	sb.append(" eleCls = cn.jmicro.agent.SerializeProxyFactory.loadClazz(cn); \n");
			    		sb.append(" } \n");
			    		
			    		sb.append(" } //block6 \n");
			    		sb.append(" Object elt = cn.jmicro.agent.SerializeProxyFactory.decodeListElement(__buffer,eleCls); \n");
				    	...
				    	sb.append(" if(0 == (cn.jmicro.common.Constants.GENERICTYPEFINAL & "+flagName+")) { //blockgenic,不能从泛型获取足够信息  \n");
			    		...
			    		sb.append(" if(readEvery) { //block6 \n");
			    		sb.append("  short prefixCode =  __buffer.readByte(); \n");
			    		sb.append("if(prefixCode == cn.jmicro.api.codec.Decoder.PREFIX_TYPE_NULL ){ "+varName+"[i]=null; continue;}");
			    		sb.append(" if(prefixCode == cn.jmicro.api.codec.Decoder.PREFIX_TYPE_SHORT) { \n");
			    		sb.append("  c =  __buffer.readShort(); \n");
			    		sb.append("  eleCls = cn.jmicro.api.codec.TypeCoderFactory.getClassByCode(new Short(c)); \n ");
			    		sb.append(" } else { \n");
			    		...
			    		sb.append(" } //block6 \n");
			    		sb.append(genericType).append(" elt = ("+genericType+") cn.jmicro.agent.SerializeProxyFactory.decodeListElement(__buffer,eleCls); \n");
			    		sb.append(" if(elt != null) { //block7 \n");
				    	...
				    	if(fieldDeclareType.isInterface() || Modifier.isAbstract(fieldDeclareType.getModifiers())) {
				    		...
				    		sb.append(" cls = cn.jmicro.api.codec.TypeCoderFactory.getClassByCode(new Short(c)); \n");
				    		sb.append(" } \n");
				    		sb.append(varName).append("=(").append(fieldDeclareType.getName()).append(") cn.jmicro.agent.SerializeProxyFactory.newInstance(cls); \n");
				    		sb.append(" __obj.").append(f.getName()).append(" = ").append(varName).append(";");
				    		sb.append(" } // block0 \n  else {  // block1 \n");
					    	sb.append(varName).append(" = __obj.").append(f.getName()).append(";");
					    	sb.append(" } // block1 \n");
				    	...
				    	sb.append(" if(0 == (cn.jmicro.common.Constants.GENERICTYPEFINAL & "+flagName+")) { //blockgenic 从头部中读取类型信息 \n");
				    	
				    	sb.append(" if(0 != (cn.jmicro.common.Constants.HEADER_ELETMENT & "+flagName+")) { \n");
				    	sb.append(" readKeyEvery = false;\n ");
				    	sb.append(" if(0 != (cn.jmicro.common.Constants.ELEMENT_TYPE_CODE & "+flagName+")) { \n");
				    	sb.append(" c = __buffer.readShort(); \n");
				    	sb.append(" keyEleCls = cn.jmicro.api.codec.TypeCoderFactory.getClassByCode(new Short(c)); \n");
				    	sb.append(" } \n else { \n");
				    	sb.append(" keyClsName = __buffer.readUTF(); \n");
				    	sb.append(" keyEleCls = cn.jmicro.agent.SerializeProxyFactory.loadClazz(keyClsName); \n");
				    	sb.append(" } \n");
				    	...
				    	sb.append(" if(0 == (cn.jmicro.common.Constants.EXT0 & "+flagName+")) { //blockgenic 不能从泛型参数获取类型信息 \n");
				    	
				    	sb.append(" if(0 != (cn.jmicro.common.Constants.EXT1 & "+flagName+")) { \n");
				    	sb.append(" readValEvery = false;\n ");
				    	sb.append(" if(0 != (cn.jmicro.common.Constants.SIZE_NOT_ZERO & "+flagName+")) { \n");
				    	sb.append(" valClsName = __buffer.readUTF(); \n");
				    	sb.append(" valEleCls = cn.jmicro.agent.SerializeProxyFactory.loadClazz(valClsName); \n");
				    	sb.append(" } \n else { \n");
				    	sb.append(" c = __buffer.readShort(); \n");
				    	sb.append(" valEleCls = cn.jmicro.api.codec.TypeCoderFactory.getClassByCode(new Short(c)); \n");
				    	sb.append(" } \n");
			    		...
			    		sb.append(" } else { \n");
			    		sb.append(" java.lang.String cn = __buffer.readUTF(); \n");
				    	sb.append(" keyEleCls = cn.jmicro.agent.SerializeProxyFactory.loadClazz(cn); \n");
			    		sb.append(" } \n");
			    		
			    		sb.append(" } //block6 \n");
			    		sb.append(" Object key = cn.jmicro.agent.SerializeProxyFactory.decodeListElement(__buffer,keyEleCls); \n");
			    		...
			    		sb.append(" } else { \n");
			    		sb.append(" java.lang.String cn = __buffer.readUTF(); \n");
				    	sb.append(" valEleCls = cn.jmicro.agent.SerializeProxyFactory.loadClazz(cn); \n");
			    		sb.append(" } \n");
			    		
			    		sb.append(" } //block6 \n");
			    		sb.append(" Object val = cn.jmicro.agent.SerializeProxyFactory.decodeListElement(__buffer,valEleCls); \n");
		...
		if("cn.jmicro.api.monitor.v2.MonitorServerStatus".equals(cls.getName())) {
			System.out.println(sb.toString());
		}
	...
	private static String getEncodeMethod(CtClass cls) throws NotFoundException, CannotCompileException {
		...
		for(int i = 0; i < fields.length; i++) {
			...
			if(fieldDeclareType == CtClass.intType ) {
				...
				sb.append("if(__val"+i).append(" == null)  { "+flagName+" |= cn.jmicro.common.Constants.NULL_VAL; \n out.write(flagIndex"+i+","+flagName+");\n}  ");
			   ...
			   if(!fieldDeclareType.subtypeOf(cp.get(Collection.class.getName())) &&
					...
					if(fieldDeclareType.hasAnnotation(SO.class)) {
						...
						sb.append(" ((cn.jmicro.api.codec.ISerializeObject)__o"+i+").encode(__buffer,null);\n");
					} else {
				    ...
				    if(fieldDeclareType.subtypeOf(cp.get(Collection.class.getName()))) {
				    	...
				    	if(fieldDeclareType.isInterface() || Modifier.isAbstract(fieldDeclareType.getModifiers())) {
				    		sb.append(" Short c = cn.jmicro.api.codec.TypeCoderFactory.getCodeByClass(__val"+i+".getClass()); \n");
				    		sb.append(" if(c == null) { "+flagName+" |= cn.jmicro.common.Constants.TYPE_VAL; \n __buffer.writeUTF(__val"+i+".getClass().getName());\n } \n");
				    	...
				    	sb.append(" boolean hasNull = cn.jmicro.agent.SerializeProxyFactory.collHasNullElement(__val"+i+");\n");
				    	...
				    	sb.append(" "+flagName+" |= cn.jmicro.common.Constants.GENERICTYPEFINAL; \n");//能从泛型中能获取到足够的列表元素类型信息
			    		sb.append(" } else { // block2 \n");
			    		//从值中获取元素类型信息
			    		sb.append(" Class firstEltCls = __val"+i+".iterator().next().getClass();\n");
			    		sb.append(" boolean sameElt = cn.jmicro.agent.SerializeProxyFactory.sameCollectionTypeEles(__val"+i+"); \n");//是否是同种类型的对象
				    	sb.append(" boolean isFinal = cn.jmicro.agent.SerializeProxyFactory.seriaFinalClass(__val"+i+".toArray());\n");
				    	
				    	sb.append(" if(sameElt && isFinal && !hasNull) { //block3 \n");
				    		sb.append(" "+flagName+" |= cn.jmicro.common.Constants.HEADER_ELETMENT; \n");//第一个元素 是否是抽象类，sameElt=true时有效
					    	//sb.append(" __buffer.writeUTF(__val"+i+".iterator().next().getClass().getName());\n");
				    		sb.append(" writeEvery = false; \n");
				    		sb.append(" Short c"+i+" = cn.jmicro.api.codec.TypeCoderFactory.getCodeByClass(firstEltCls);\n");
				    		sb.append(" if(c"+i+" == null) {");
				    		sb.append(" "+flagName+" |= cn.jmicro.common.Constants.ELEMENT_TYPE_CODE; \n");
					   ...
					   // sb.append(" if(writeEvery) {__buffer.writeUTF(v.getClass().getName());\n}");
					    ...
					    sb.append(" if(v == null) {  __buffer.writeByte(cn.jmicro.api.codec.Decoder.PREFIX_TYPE_NULL); continue; \n } \n");
					    sb.append(" Short cc"+i+" = cn.jmicro.api.codec.TypeCoderFactory.getCodeByClass(v.getClass()); \n");
					    sb.append(" if(cc"+i+"==null) { cn.jmicro.agent.SerializeProxyFactory.errorToSerializeObjectCode(v.getClass().getName());\n");
					    sb.append(" __buffer.writeByte(cn.jmicro.api.codec.Decoder.PREFIX_TYPE_PROXY);\n");
					    sb.append("  __buffer.writeUTF(v.getClass().getName()); ");
					    sb.append(" } \n  else { \n");
					    sb.append(" __buffer.writeByte(cn.jmicro.api.codec.Decoder.PREFIX_TYPE_SHORT);\n");
					    sb.append(" __buffer.writeShort(cc"+i+".intValue());}\n}\n");
					    
					    sb.append(" cn.jmicro.agent.SerializeProxyFactory.encodeListElement(__buffer,v); \n");
					   ...
					   /* sb.append(" System.out.println(\"Endoce Flag: \" + ")
				    	...
				    	sb.append(" boolean hasNull = cn.jmicro.agent.SerializeProxyFactory.hasNullElement(__val"+i+");\n");
				    	...
				    	sb.append("if(!hasNull && ( java.lang.reflect.Modifier.isFinal(" + genericType + ".class.getModifiers()) ||cn.jmicro.api.codec.ISerializeObject.class.isAssignableFrom("+genericType+".class))) { \n"); 
				    	sb.append(" "+flagName+" |= cn.jmicro.common.Constants.GENERICTYPEFINAL; \n");//能从泛型中能获取到足够的列表元素类型信息
			    		sb.append(" } else { // block2 \n");
			    		//从值中获取元素类型信息
			    		sb.append(" boolean sameElt = cn.jmicro.agent.SerializeProxyFactory.sameArrayTypeEles(__val"+i+"); \n");//是否是同种类型的对象
				    	sb.append(" boolean isFinal = cn.jmicro.agent.SerializeProxyFactory.seriaFinalClass(__val"+i+");\n");
				    	
				    	sb.append(" if(sameElt && isFinal && !hasNull) { //block3 \n");
				    		sb.append(" "+flagName+" |= cn.jmicro.common.Constants.HEADER_ELETMENT; \n");//第一个元素 是否是抽象类，sameElt=true时有效
					    	//sb.append(" __buffer.writeUTF(__val"+i+".iterator().next().getClass().getName());\n");
				    		sb.append(" writeEvery = false; \n");
				    		sb.append(" Short c"+i+" = cn.jmicro.api.codec.TypeCoderFactory.getCodeByClass(__val"+i+"[0].getClass());\n");
				    		sb.append(" if(c"+i+" == null) {");
				    		sb.append(" "+flagName+" |= cn.jmicro.common.Constants.ELEMENT_TYPE_CODE; \n");
					   ...
					   /* sb.append(" System.out.println(\"Endoce Flag: \" + ")
				    	...
				    	sb.append(" boolean hasNullKeyElt = cn.jmicro.agent.SerializeProxyFactory.collHasNullElement(__val"+i+".keySet());//是否有空元素的KEY \n");
				    	
				    	//encode Key type
				    	sb.append("if( !hasNullKeyElt && ").append(keyType==null ? "null" : keyType + ".class").append("!= null && (java.lang.reflect.Modifier.isFinal(" + keyType + ".class.getModifiers()) ||cn.jmicro.api.codec.ISerializeObject.class.isAssignableFrom("+keyType+".class))) { \n"); 
				    	sb.append(" "+flagName+" |= cn.jmicro.common.Constants.GENERICTYPEFINAL; //能从泛型中能获取到足够的列表元素类型信息\n");
			    		sb.append(" } else { // block2 \n");
			    		//从值中获取元素类型信息
			    		sb.append(" boolean sameKeyElt = cn.jmicro.agent.SerializeProxyFactory.sameCollectionTypeEles(__val"+i+".keySet());//是否是同种类型的对象 \n");
				    	sb.append(" boolean isKeyFinal = cn.jmicro.agent.SerializeProxyFactory.seriaFinalClass(__val"+i+".keySet().iterator().next().getClass());\n");
				    	...
				    	sb.append(" if(sameKeyElt && isKeyFinal && !hasNullKeyElt) { //block3 \n");
				    		...
				    		sb.append(" Short c"+i+" = cn.jmicro.api.codec.TypeCoderFactory.getCodeByClass(cls);\n");
				    		sb.append(" if(c"+i+" == null) {");
				    		sb.append(" "+flagName+" |= cn.jmicro.common.Constants.ELEMENT_TYPE_CODE; \n");
				    	...
				    	sb.append(" boolean hasNullValElt = cn.jmicro.agent.SerializeProxyFactory.collHasNullElement(__val"+i+".values());//是否有空元素的值 \n");
				    	//encode value type
				    	...
				    	sb.append(" "+flagName+" |= cn.jmicro.common.Constants.EXT0; \n");//能从泛型中能获取到足够的列表元素类型信息
			    		sb.append(" } else { // block2 \n");
			    		//从值中获取元素类型信息
			    		sb.append(" boolean sameValElt = cn.jmicro.agent.SerializeProxyFactory.sameCollectionTypeEles(__val"+i+".values()); \n");//是否是同种类型的对象
				    	sb.append(" boolean isValFinal = cn.jmicro.agent.SerializeProxyFactory.seriaFinalClass(__val"+i+".values().toArray());\n");
				    	
				    	sb.append(" if(sameValElt && isValFinal && !hasNullValElt) { //block3 \n");
				    		sb.append(" "+flagName+" |= cn.jmicro.common.Constants.EXT1;//首值编码 \n");//第一个元素 是否是抽象类，sameElt=true时有效
					   ...
					   // sb.append(" if(writeEvery) {__buffer.writeUTF(v.getClass().getName());\n}");
					    ...
					    sb.append(" if(key == null) {  __buffer.writeByte(cn.jmicro.api.codec.Decoder.PREFIX_TYPE_NULL); continue; \n } \n");
					    sb.append(" Short cc"+i+" = cn.jmicro.api.codec.TypeCoderFactory.getCodeByClass(key.getClass()); \n");
					    sb.append(" if(cc"+i+"==null) { cn.jmicro.agent.SerializeProxyFactory.errorToSerializeObjectCode(key.getClass().getName());\n");
					    sb.append(" __buffer.writeByte(cn.jmicro.api.codec.Decoder.PREFIX_TYPE_PROXY);\n");
					    ...
					    sb.append(" cn.jmicro.agent.SerializeProxyFactory.encodeListElement(__buffer,key); \n");
					    
					    sb.append(" if(writeValEvery) { \n ");
					    sb.append(" if(val == null) {  __buffer.writeByte(cn.jmicro.api.codec.Decoder.PREFIX_TYPE_NULL); continue; \n } \n");
					    sb.append(" Short cc"+i+" = cn.jmicro.api.codec.TypeCoderFactory.getCodeByClass(val.getClass()); \n");
					    sb.append(" if(cc"+i+"==null) { cn.jmicro.agent.SerializeProxyFactory.errorToSerializeObjectCode(val.getClass().getName());\n");
					    sb.append(" __buffer.writeByte(cn.jmicro.api.codec.Decoder.PREFIX_TYPE_PROXY);\n");
					    ...
					    sb.append(" cn.jmicro.agent.SerializeProxyFactory.encodeListElement(__buffer,val); \n");
					    sb.append(" } //end for loop block5 \n ");
...
*/				}
	...
	public static Class loadClazz(String clsName) {
		...
		if(cl == null) {
			cl = SerializeProxyFactoryBackup.class.getClassLoader();
		}
		Class cls = null;

...
public class NettyTCPSocketServer implements IServer {

	static final Logger logger = LoggerFactory.getLogger(NettyTCPSocketServer.class);
	
	private static final String TAG = NettyTCPSocketServer.class.getName();

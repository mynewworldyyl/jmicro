		...
		if (__val8 == null) {
			...
			if (size > 0) { // if block1
				...
				if (java.lang.Object.class != null && (java.lang.reflect.Modifier
					...
					boolean sameElt = cn.jmicro.agent.AddSerializedToObject.sameArrayTypeEles(__val8);
					boolean isFinal = cn.jmicro.agent.AddSerializedToObject.seriaFinalClass(__val8);

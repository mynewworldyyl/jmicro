...
public class ReportData0 {
	...
	public void encode(java.io.DataOutput __buffer, Object obj) throws java.io.IOException {
		...
		if (__val0 == null) {
			...
			if (size > 0) { // if block1
				...
				if (java.lang.Short.class != null && (java.lang.reflect.Modifier
					...
					boolean sameElt = cn.jmicro.agent.SerializeProxyFactory.sameArrayTypeEles(__val0);
					boolean isFinal = cn.jmicro.agent.SerializeProxyFactory.seriaFinalClass(__val0);
					boolean hasNull = cn.jmicro.agent.SerializeProxyFactory.hasNullElement(__val0);
		...
		if (__val1 == null) {
			...
			if (size > 0) { // if block1
				boolean writeEvery = false;
				boolean hasNull = cn.jmicro.agent.SerializeProxyFactory.hasNullElement(__val1);
				if (!hasNull && (java.lang.reflect.Modifier
					...
					boolean sameElt = cn.jmicro.agent.SerializeProxyFactory.sameArrayTypeEles(__val1);
					boolean isFinal = cn.jmicro.agent.SerializeProxyFactory.seriaFinalClass(__val1);
		...
		if (__val2 == null) {
			...
			if (size > 0) { // if block1
				boolean writeEvery = false;
				boolean hasNull = cn.jmicro.agent.SerializeProxyFactory.hasNullElement(__val2);
				if (!hasNull && (java.lang.reflect.Modifier
					...
					boolean isFinal = cn.jmicro.agent.SerializeProxyFactory.seriaFinalClass(__val2);

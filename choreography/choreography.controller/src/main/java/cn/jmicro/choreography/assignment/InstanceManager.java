...
import cn.jmicro.choreography.base.InstanceInfo;
import cn.jmicro.choreography.controller.IAgentListener;
import cn.jmicro.choreography.controller.IInstanceListener;
...
public class InstanceManager {
	...
	public void createInstance(InstanceInfo ai,boolean isElp) {
		...
		String path = ChoyConstants.ROOT_AGENT + "/" + ai.getAgentName() +"_"
	...
	private String agentPath(AgentInfo agent) {
		return ChoyConstants.ROOT_AGENT+"/"+agent.getName()+"_"+agent.getId();
	}

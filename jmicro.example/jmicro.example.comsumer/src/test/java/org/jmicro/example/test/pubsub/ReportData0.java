...
public class ReportData0 {
	...
	public void encode(java.io.DataOutput __buffer, Object obj) throws java.io.IOException {
		...
		if (__val0 == null) {
			flag0 |= org.jmicro.common.Constants.NULL_VAL;
			...
			if (size > 0) { // if block1
				...
				if (java.lang.Short.class != null && (java.lang.reflect.Modifier
						...
						|| org.jmicro.api.codec.ISerializeObject.class.isAssignableFrom(java.lang.Short.class))) {
					flag0 |= org.jmicro.common.Constants.GENERICTYPEFINAL;
				} else { // block2
					boolean sameElt = org.jmicro.agent.SerializeProxyFactory.sameArrayTypeEles(__val0);
					boolean isFinal = org.jmicro.agent.SerializeProxyFactory.seriaFinalClass(__val0);
					boolean hasNull = org.jmicro.agent.SerializeProxyFactory.hasNullElement(__val0);
					if (sameElt && isFinal && !hasNull) { // block3
						flag0 |= org.jmicro.common.Constants.HEADER_ELETMENT;
						writeEvery = false;
						Short c0 = org.jmicro.api.codec.TypeCoderFactory.getCodeByClass(__val0[0].getClass());
						if (c0 == null) {
							flag0 |= org.jmicro.common.Constants.ELEMENT_TYPE_CODE;
		...
		__buffer.writeByte(0); // forward one byte
		if (__val1 == null) {
			flag1 |= org.jmicro.common.Constants.NULL_VAL;
			...
			if (size > 0) { // if block1
				boolean writeEvery = false;
				boolean hasNull = org.jmicro.agent.SerializeProxyFactory.hasNullElement(__val1);
				if (!hasNull && (java.lang.reflect.Modifier
					...
					flag1 |= org.jmicro.common.Constants.GENERICTYPEFINAL;
				} else { // block2
					boolean sameElt = org.jmicro.agent.SerializeProxyFactory.sameArrayTypeEles(__val1);
					boolean isFinal = org.jmicro.agent.SerializeProxyFactory.seriaFinalClass(__val1);
					
					if (sameElt && isFinal && !hasNull) { // block3
						flag1 |= org.jmicro.common.Constants.HEADER_ELETMENT;
						writeEvery = false;
						Short c1 = org.jmicro.api.codec.TypeCoderFactory.getCodeByClass(__val1[0].getClass());
						if (c1 == null) {
							flag1 |= org.jmicro.common.Constants.ELEMENT_TYPE_CODE;
				...
				for (int i = 0; i < size; i++) { // loop block5
					...
					if (writeEvery) {
						...
						Short cc1 = org.jmicro.api.codec.TypeCoderFactory.getCodeByClass(v.getClass());
						if (cc1 == null) {
							org.jmicro.agent.SerializeProxyFactory.errorToSerializeObjectCode(v.getClass().getName());
							__buffer.writeByte(org.jmicro.api.codec.Decoder.PREFIX_TYPE_PROXY);
							__buffer.writeUTF(v.getClass().getName());
		...
		if (__val2 == null) {
			...
			if (size > 0) { // if block1
				boolean writeEvery = false;
				boolean hasNull = org.jmicro.agent.SerializeProxyFactory.hasNullElement(__val2);
				if (!hasNull && (java.lang.reflect.Modifier
						.isFinal(java.lang.Double.class.getModifiers())
						|| org.jmicro.api.codec.ISerializeObject.class.isAssignableFrom(java.lang.Double.class))) {
	...
	public void decode(java.io.DataInput __buffer) throws java.io.IOException {
		...
		__val0 = null;
		if (0 != (org.jmicro.common.Constants.NULL_VAL & flagName0)) {
			__val0 = null;
		} else { // block0
			org.jmicro.api.codec.typecoder.TypeCoder __coder = org.jmicro.api.codec.TypeCoderFactory.getDefaultCoder();
			String clsName = null;
			...
			if (size > 0) { // block2
				...
				clsName = null;
				c = 0;
				if (0 == (org.jmicro.common.Constants.GENERICTYPEFINAL & flagName0)) { // blockgenic,不能从泛型获取足够信息
					if (0 != (org.jmicro.common.Constants.HEADER_ELETMENT & flagName0)) {
						readEvery = false;
						if (0 == (org.jmicro.common.Constants.ELEMENT_TYPE_CODE & flagName0)) {
				...
				for (int i = 0; i < size; i++) { // block5
					if (readEvery) { // block6
						...
						if (prefixCode == org.jmicro.api.codec.Decoder.PREFIX_TYPE_NULL) {
							__val0[i] = null;
							continue;
						}
					...
					java.lang.Short elt = (java.lang.Short) org.jmicro.agent.SerializeProxyFactory
		...
		__val1 = null;
		if (0 != (org.jmicro.common.Constants.NULL_VAL & flagName1)) {
			__val1 = null;
		} else { // block0
			org.jmicro.api.codec.typecoder.TypeCoder __coder = org.jmicro.api.codec.TypeCoderFactory.getDefaultCoder();
			String clsName = null;
			...
			if (size > 0) { // block2
				...
				clsName = null;
				c = 0;
				if (0 == (org.jmicro.common.Constants.GENERICTYPEFINAL & flagName1)) { // blockgenic,不能从泛型获取足够信息
					if (0 != (org.jmicro.common.Constants.HEADER_ELETMENT & flagName1)) {
						readEvery = false;
						if (0 == (org.jmicro.common.Constants.ELEMENT_TYPE_CODE & flagName1)) {
							c = __buffer.readShort();
							eleCls = org.jmicro.api.codec.TypeCoderFactory.getClassByCode(new Short(c));
						} else {
							clsName = __buffer.readUTF();
				...
				for (int i = 0; i < size; i++) { // block5
					...
					java.lang.String elt = (java.lang.String) org.jmicro.agent.SerializeProxyFactory
							.decodeListElement(__buffer, eleCls);
					if (elt != null) { // block7
						__val1[i] = elt;
					} // block7
		...
		if (0 != (org.jmicro.common.Constants.NULL_VAL & flagName2)) {
			...
			if (size > 0) { // block2
				...
				for (int i = 0; i < size; i++) { // block5
					...
					java.lang.Double elt = (java.lang.Double) org.jmicro.agent.SerializeProxyFactory
							.decodeListElement(__buffer, eleCls);
					if (elt != null) { // block7
						__val2[i] = elt;
					} // block7

...
public final class SubmitItem {
	...
	public void encode(java.io.DataOutput __buffer, Object obj) throws java.io.IOException {
		...
		if (__val8 == null) {
			...
			if (size > 0) { // if block1
				...
				if (java.lang.Object.class != null && (java.lang.reflect.Modifier
					...
					flag8 |= org.jmicro.common.Constants.GENERICTYPEFINAL;
				} else { // block2
					boolean sameElt = org.jmicro.agent.SerializeProxyFactory.sameArrayTypeEles(__val8);
					boolean isFinal = org.jmicro.agent.SerializeProxyFactory.seriaFinalClass(__val8);
					if (sameElt && isFinal) { // block3
						flag8 |= org.jmicro.common.Constants.HEADER_ELETMENT;
						writeEvery = false;
						Short c8 = org.jmicro.api.codec.TypeCoderFactory.getCodeByClass(__val8[0].getClass());
						if (c8 == null) {
							flag8 |= org.jmicro.common.Constants.ELEMENT_TYPE_CODE;
				...
				for (int i = 0; i < size; i++) { // loop block5
					...
					if (writeEvery) {
						...
						Short cc8 = org.jmicro.api.codec.TypeCoderFactory.getCodeByClass(v.getClass());
						if (cc8 == null) {
		...
		org.jmicro.api.net.Message __val10 = __obj.msg;
		byte flag10 = 0;
		...
		if (__val10 == null) {
			...
			__coder.encode(__buffer, __val10, org.jmicro.api.net.Message.class, null);

			out.write(flagIndex10, flag10);
		} // end else block0

		org.jmicro.api.net.IReq __val11 = __obj.req;
		byte flag11 = 0;
		int flagIndex11 = out.position();
		__buffer.writeByte(0); // forward one byte
		if (__val11 == null) {
			flag11 |= org.jmicro.common.Constants.NULL_VAL;
			out.write(flagIndex11, flag11);
		} else { // block0
			__coder.encode(__buffer, __val11, org.jmicro.api.net.IReq.class, null);

			out.write(flagIndex11, flag11);
		} // end else block0

		org.jmicro.api.net.IResp __val12 = __obj.resp;
		byte flag12 = 0;
		int flagIndex12 = out.position();
		__buffer.writeByte(0); // forward one byte
		if (__val12 == null) {
			flag12 |= org.jmicro.common.Constants.NULL_VAL;
			out.write(flagIndex12, flag12);
		} else { // block0
			__coder.encode(__buffer, __val12, org.jmicro.api.net.IResp.class, null);
